...
import { FaGithub, FaMoon, FaSun, FaCode } from "react-icons/fa";
      ...
      {!path.includes("dashboard") && (
        ...
        >
          ...
          <Link
            ...
            fontSize={"small"}
            backgroundColor={"transparent"}
            href="https://github.com/lavanbhakti/PrimeChat-App"
            mx={1}
          >
            <FaGithub />
          </Link>
        ...
        <Flex justify={"space-between"}>
          ...
          >
            ...
            <Button
              ...
              mr={2}
              onClick={() => {
                window.open("https://github.com/lavanbhakti/PrimeChat-App");
              }}
            >
              <FaGithub />
            </Button>
